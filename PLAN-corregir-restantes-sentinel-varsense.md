...
**Pendiente del usuario (decisión, no bloqueo):** push a GitHub de varsense V14→V18 (único paso que deja WANDORIUS y los 7 sourcePath durables en ALINEADO); luego re-alineación del runtime del servidor 8787 y borrado (o no) de las muertas reales de PT.
